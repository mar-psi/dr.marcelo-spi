...
export function SocialAuthButton({
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      className={cn(
        "w-full h-11 flex items-center justify-center gap-3 rounded-xl",
    ...
    >
      {loading ? (
        <div className="w-4 h-4 rounded-full border-2 border-content-disabled border-t-transparent animate-spin" />
      ) : (
        <GoogleIcon />
      )}
